...
public class LibraySystem {
    private static final String ADMIN_USERNAME = "Lenovo";
    private static final String ADMIN_PASSWORD = "ind";
    private static final String[] MAHASISWA_NIM = {"202310370311091"};
